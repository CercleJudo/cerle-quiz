...
with col1:
    ...
    st.markdown(
        f"""
        <div style="display:inline-flex; box-sizing:border-box; padding:18px 0; background:#ffffff; border-radius:8px; overflow:hidden; align-items:center; justify-content:center;">
