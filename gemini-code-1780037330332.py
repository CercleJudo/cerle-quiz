...
QUIZ_DATA = {
    "Ceinture Blanche-Jaune": [
        ...
        {"question": "Comment appelle-t-on la ceinture du judoka ?", "options": ["Obi", "Uwagi", "Zubon", "Himo"], "answer": "Obi"},
    ...
    "Ceinture Orange": [
        ...
        {"question": "Quelle technique signifie 'roue autour du genou' ?", "options": ["Hiza-guruma", "Ashi-guruma", "Uki-goshi", "Sumi-gaeshi"], "answer": "Hiza-guruma"},
        {"question": "Quelle technique signifie 'Contrôle par l'épaule' ?", "options": ["Kata-gatame", "Seoi-gaeshi", "Juji-gatame", "Waki-gatame"], "answer": "Kata-gatame"},
        {"question": "Les ceintures de couleurs blanche à marron correspondent à des grades nommés :", "options": ["Kyu", "Shiro", "Hantaï", "Hippu"], "answer": "Kyu"},
    ...
    "Ceinture Bleue": [
        ...
        {"question": "Quelle technique signifie 'Renversement dans le coin' ?", "options": ["Sumi-gaeshi", "Tomoe-nage", "Hiki-gaeshi", "Tani-otoshi"], "answer": "Sumi-gaeshi"},
    ...
    "Ceinture Marron": [
        ...
        {"question": "Comment se traduit la technique de sacrifice 'Daki-wakare' ?", "options": ["Séparation en enlaçant / en brassant", "Chute flottante arrière", "Roue autour des hanches", "Clé de bras par la jambe"], "answer": "Séparation en enlaçant / en brassant"},
...
with col1:
    ...
    st.markdown(
        f"""
        <div style="display:inline-flex; box-sizing:border-box; padding:16px 0; background:#ffffff; border-radius:8px; overflow:hidden; align-items:center; justify-content:center;">
